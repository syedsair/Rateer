# Generated by Django 4.0.2 on 2022-04-03 16:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Receiver', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_receiver_person', to=settings.AUTH_USER_MODEL)),
                ('Sender', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='%(class)s_sender_person', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
